...
|------|------|
| IC | L298N |
| 제어 방식 | GPIO ON/OFF (BCM2711 레지스터 직접 접근) |
| 모터 채널 | A (PWMA/DIRA), B (PWMB/DIRB) |

### GPIO 핀 매핑 (BCM 번호 기준)

| 드라이버 핀 | BCM | Physical | 역할 |
|-------------|:---:|:--------:|------|
| PWMA (E1)   | 16  | 36       | 모터A 활성 |
| DIRA (M1)   | 20  | 38       | 모터A 방향 |
| PWMB (E2)   | 17  | 11       | 모터B 활성 |
| DIRB (M2)   | 27  | 13       | 모터B 방향 |

> 핀 번호 변경 시 `l298n.h` 상단 `#define` 수정

### 방향 제어 진리표

| 동작   | DIRA(M1) | DIRB(M2) | PWMA(E1) | PWMB(E2) |
|--------|:--------:|:--------:|:--------:|:--------:|
| 전진   | HIGH     | LOW      | 0        | 1        |
| 후진   | HIGH     | HIGH     | 0        | 1        |
| 좌회전 | LOW      | HIGH     | 1        | 0        |
